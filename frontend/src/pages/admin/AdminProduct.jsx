...
const AdminProduct = () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/product/update/${editProduct._id}`, formData, {
        headers: {
  ...
  const deleteProductHandler = async (productId) => {
    try {
      ...
      const res = await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/api/product/delete/${productId}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`
        }
      })
    ...
    <div className='pl-[350px] py-20 pr-20   flex flex-col gap-3 min-h-screen bg-gray-100'>
      ...
      <div className='grid lg:grid-cols-2'>
        ...
        filteredProducts.map((product, idx) => {
          ...
          return <Card key={idx} className="px-4 mt-4 mx-auto ">
